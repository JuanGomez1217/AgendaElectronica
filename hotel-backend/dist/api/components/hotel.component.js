...
class HotelComponent {
    ...
    getHotelForID(id_hotel) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield hotel_model_1.Hotel.findByPk(id_hotel, { raw: true }).then(result => {
                    if (result) {
                        return {
    ...
    updateCategory(id_hotel, category) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield hotel_model_1.Hotel.update({
                    categoria: category
                }, {
                    where: {
                        hotelID: id_hotel
